...
// TODO: Convert this class component to a functional component
export default class InputSpinner extends Component<
  PropsWithChildren<InputSpinnerProps>,
  InputSpinnerState
> {
  ...
  constructor(props: PropsWithChildren<InputSpinnerProps>) {
    super(props);
    if (!this.props.type)
  ...
  onChange(num: any, event: any) {
    ...
    } else if (this.intMatch("" + currentValue)) {
      currentValue = Number(currentValue);
      if (!this.minReached(currentValue)) {
        if (this.maxReached(currentValue)) {
          currentValue = this.state.max;
  ...
  render() {
    return (
      <InputGroup size={this.props.size}>
        <InputGroup.Prepend>{this.renderLeftButton()}</InputGroup.Prepend>
        {this.props.prepend}
        <Form.Control
        ...
        {this.props.children}
        {this.props.append}
        <InputGroup.Append>{this.renderRightButton()}</InputGroup.Append>
      </InputGroup>
    );
  }
}
